...
def main(methods):
    ...
    for method in methods:
        ...
        model = EdgeWeightPredictor(num_features, 1, 0.01)
        ...
        # Ploter
        plot = Plot()
        plot.graficar_loss_no_cutoff(train_loss, val_loss, name, method, 'edge_regression', num_epochs)
        # Guardar modelo
    ...
    tabla.to_csv('tables/pip_edge_regression_table' + str(num_epochs)  + '.csv', index=False)
