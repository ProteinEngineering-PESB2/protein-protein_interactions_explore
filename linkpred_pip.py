...
def main(methods):
    ...
    for method in methods:
        ...
        n = int(num_edges * 0.8) # Primera division  
        ...
        # Ploter
        plot = Plot()
        plot.graficar_loss(train_loss, val_loss, cutoff, name, method, 'linkpred', num_epochs)
        plot.graficar_accuracy(train_accuracys, val_accuracys, cutoff, name, method, 'linkpred', num_epochs)
        # Guardar modelo
    ...
    tabla.to_csv('tables/pip_linkpred_table' + str(num_epochs) + '.csv', index=False)
