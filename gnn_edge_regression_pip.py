...
def main(methods, transform_method):
    ...
    for method in methods:
        ...
        # Ploter
        plot = Plot()
        plot.graficar_loss_no_cutoff(train_loss, val_loss, name, method, 'edge_regression', num_epochs, transform_method)
        # Guardar modelo
    ...
    tabla.to_csv('tables/' + transform_method + '/pip_edge_regression_table' + str(num_epochs) + '.csv', index=False)
